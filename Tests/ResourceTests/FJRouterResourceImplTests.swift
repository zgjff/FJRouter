...
struct FJRouterResourceImplTests {
    ...
    @Test func getNotNil() async throws {
        ...
        #expect(intvalue1 == 1)
        let intvalue2: Int = try await impl.get(.loc("/intvalue1"), inMainActor: true)
        #expect(intvalue2 == 1)
        let intvalue3: Int? = try await impl.get(.loc("/intvalue1"), inMainActor: true)
        #expect(intvalue3 == 1)
        let stringvalue1: String = try await impl.get(.loc("/stringvalue1"), inMainActor: false)
        #expect(stringvalue1 == "haha")
        
        let aTestable1: ATestable = try await impl.get(.loc("/protocolATest/1"), inMainActor: false)
        #expect(aTestable1.value == 3)
        
        let aTestable2: ATestable = try await impl.get(.loc("/protocolATest/0"), inMainActor: true)
        #expect(aTestable2.value == 13)
        
        let aTestable3: BModel = try await impl.get(.loc("/protocolATest/0"), inMainActor: false)
        #expect(aTestable3.value == 13)
    }
    
    @Test func getNil() async throws {
        let intOptionalvalue1: Int = try await impl.get(.loc("/intOptionalvalue1"), inMainActor: false)
        #expect(intOptionalvalue1 == 1)
        let intOptionalvalue2: Int? = try await impl.get(.loc("/intOptionalvalue1"), inMainActor: false)
        #expect(intOptionalvalue2 == 1)
        
        let intOptionalvalue3: Int? = try await impl.get(.loc("/intOptionalvalue2"), inMainActor: false)
        #expect(intOptionalvalue3 == nil)
        
        let intOptionalvalue4: Int? = try await impl.get(.loc("/intOptionalvalue3/1"), inMainActor: false)
        #expect(intOptionalvalue4 == nil)
        
        let intOptionalvalue5: Int? = try await impl.get(.loc("/intOptionalvalue3/0"), inMainActor: false)
    ...
    @Test func getValueTypeError() async throws {
        await #expect(throws: FJRouter.GetResourceError.valueType) {
            let _: String = try await impl.get(.loc("/intvalue1"), inMainActor: false)
        }
        await #expect(throws: FJRouter.GetResourceError.valueType) {
            let _: Int = try await impl.get(.loc("/intOptionalvalue2"), inMainActor: false)
        }
        await #expect(throws: FJRouter.GetResourceError.valueType) {
            let _: BModel = try await impl.get(.loc("/protocolATest/1"), inMainActor: false)
        }
    }
    
    @Test func getValueByNameWithNoParams() async throws {
        let intvalue1: Int = try await impl.get(.name("intvalue1"), inMainActor: true)
        #expect(intvalue1 == 1)
        let intvalue11: Int = try await impl.get(.name("intvalue1"), inMainActor: false)
        #expect(intvalue11 == 1)
        
        let intOptionalvalue1: Int? = try await impl.get(.name("intOptionalvalue1"), inMainActor: true)
        #expect(intOptionalvalue1 == 1)
        let intOptionalvalue111: Int? = try await impl.get(.name("intOptionalvalue1"), inMainActor: false)
        #expect(intOptionalvalue111 == 1)
        
        let intOptionalvalue2: Int? = try await impl.get(.name("intOptionalvalue2"), inMainActor: true)
        #expect(intOptionalvalue2 == nil)
        let intOptionalvalue22: Int? = try await impl.get(.name("intOptionalvalue2"), inMainActor: false)
        #expect(intOptionalvalue22 == nil)
    }
    
    @Test func getValueByNameWithParams() async throws {
        let intOptionalvalue3: Int? = try await impl.get(.name("intOptionalvalue3", params: ["optional": "1"]), inMainActor: true)
        #expect(intOptionalvalue3 == nil)
        
        let intOptionalvalue31: Int? = try await impl.get(.name("intOptionalvalue3", params: ["optional": "0"]), inMainActor: false)
